package com.giztv.tv.ui.update
...
import com.giztv.tv.update.AppUpdateService
import com.giztv.tv.update.buildInstallIntent
import com.giztv.tv.update.cancelUpdateNotification
import java.io.File
        ...
        is UpdateUiState.Downloading -> {
          ...
          if (progress == null) {
            LinearProgressIndicator(
              ...
              color = GizMint,
              trackColor = GizBlue.copy(alpha = .2f),
            )
          } else {
            LinearProgressIndicator(
